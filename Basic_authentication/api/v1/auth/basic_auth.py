...
class BasicAuth(Auth):
    ...
    def current_user(self, request=None) -> TypeVar("User"):
        ...
        try:
            ...
            bs64 = self.extract_base64_authorization_header(header)
            decodebs64 = self.decode_base64_authorization_header(bs64)
            userPass = self.extract_user_credentials(decodebs64)
